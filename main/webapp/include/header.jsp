                 ...
                 <div class="top_menu_community">
                    ...
                    <div class="top_pop">
                        <ul><li class="top_pop_m"><a href="myshop/index.html"><img src="<%=request.getContextPath()%>/web/images/etc/icon_user.png"/></a>
                                <div class="sub">
                                    <ul module="Layout_BoardInfo---" class="sub"><li><a href="myshop/index.html">마이쇼핑</a></li>
                            ...
                            <li>
                                <div class="search_box search_menu"><a href="#none"><img src="<%=request.getContextPath()%>/web/images/etc/btn_search.png" style="   padding:-0px 0 0 4px;"/>  </a>
...
<fieldset>
<legend>검색</legend>
                                                    <input id="keyword" name="keyword" class="inputTypeText" placeholder="" onmousedown="SEARCH_BANNER.clickSearchForm(this)" value="" type="text"  /><input type="image" src="/web/images/etc/btn_search.png" alt="검색" onclick="SEARCH_BANNER.submitSearchBanner(this); return false;"/><%-- <ul class="autoDrop" id=""></ul>--%>
</fieldset>
</div>
</form> 
                                            <div class="search_btn"><img src="/include/sum/btn_close.png"/></div>
                                        </div>
                                    </div><!-- search_over -->            
                                </div><!-- search_box -->                              
                ...
                <h1 class="xans-element- xans-layout xans-layout-logotop "><a href="<%=request.getContextPath()%>/index2.jsp"><img src="<%=request.getContextPath()%>/web/upload/logo/logo2.png" alt="쇼핑몰 이름"/></a>
</h1>
                ...
                <div class="top_menu_log">
                   ...
                   --%>
                     <div class="xans-element- xans-layout xans-layout-statelogoff "><a href="<%=request.getContextPath()%>/member/login.jsp" class="log" style="font-size: 15px;">LOGIN</a>
<a href="<%=request.getContextPath()%>/member/join.jsp" style="font-size: 15px;"><div id="point_Box">
...
<div class="updown"></div>
                    ...
                    <div class="top_pop_co">
                        <ul><li class="top_pop_co_m"><a href="myshop/index.html" style="font-size: 15px;">COMMUNITY<img src="<%=request.getContextPath()%>/web/images/etc/btn_top_pop.png"/></a>
                                <div class="sub">
                                    <ul class="xans-element- xans-layout xans-layout-boardinfo sub"><li class="xans-record-">
<a href="board/공지사항/1/index.html" style="font-size:13px;">공지사항</a> </li>
<li class="xans-record-">
<a href="board/상품-사용후기/4/index.html" style="font-size:13px;">사용후기</a> </li>
<li class="xans-record-">
<a href="board/상품-qa/6/index.html" style="font-size:13px;">상품 Q&A</a> </li>
<li class="xans-record-">
<a href="board/자유게시판/5/index.html" style="font-size:13px;">자유게시판</a> </li>
...
<li class="xans-record-" ><a href="<%=request.getContextPath()%>/category/bestitem/bestitem.jsp" style="font: 20px bold;">BEST ITEM</a></li>
...
<li class="xans-record-"><a href="<%=request.getContextPath()%>/category/300_clean/301/clean.jsp" style="font: 20px bold;">수납&정리</a></li>
