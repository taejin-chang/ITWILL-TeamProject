...
<div class="titleArea">
    <h2>아이디 찾기</h2>
    <ul><li>가입하신 방법에 따라 아이디 찾기가 가능합니다.</li>
...
<input id="returnUrl" name="returnUrl" value="/member/id/find_id_result.html" type="hidden"  /><div class="xans-element- xans-member xans-member-findid ec-base-box typeThin "><!--
...
<option value="fore">외국인회원</option>
            ...
            <p class="check"><input id="check_method0" name="check_method" fw-filter="" fw-label="찾는방법" fw-msg="" value="1" type="radio"  /><label for="check_method0" ><span id="ssn_lable" style="display:inline;"></span></label>
...
<input id="check_method2" name="check_method" fw-filter="" fw-label="찾는방법" fw-msg="" value="3" type="radio"  /><label for="check_method2" ><span id="search_type_mobile_lable" style="display:inline;">휴대폰번호</span></label></p>
            <p id="name_view" class="name"><strong id="name_lable">이름</strong> <input id="name" name="name" fw-filter="" fw-label="이름" fw-msg="" class="lostInput" placeholder="" value="" type="text"  /></p>
            <p id="ssn_view" class="ssn_no"><strong id="ssn_name">법인번호로 찾기</strong> <input id="ssn1" name="ssn1" fw-filter="isMin[6]&isMax[6]&isNumber" fw-label="주민등록번호" fw-msg="" class="lostInput" placeholder="" maxlength="6" value="" type="text"  /> - <input id="ssn2" name="ssn2" fw-filter="isMin[7]&isMax[7]&isNumber" fw-label="주민등록번호" fw-msg="" class="lostInput" maxlength="7" value="" type="password"  /></p>
            <p id="email_view" class="email" style="display:none;"><strong>이메일로 찾기</strong> <input id="email" name="email" fw-filter="isEmail" fw-label="이메일" fw-msg="" class="lostInput" placeholder="" value="" type="text"  /></p>
            ...
            <p id="ipin_view" class="ipin" style="display:none;">
                <strong>아이핀인증으로 찾기</strong>
                <span>회원가입을 아이핀으로 가입하신 <br/>회원님께서는 아이핀으로 인증하세요.</span>
                <a href="#none" class="btnNormal" onclick="findId.action('ecudemo200642' , 'kcp'); return false;"><img src="//img.echosting.cafe24.com/skin/base/common/btn_icon_ipin.gif" alt=""/> 아이핀인증</a>
            </p>
            ...
            <div class="ec-base-button gColumn">
                <a href="#none" class="btnSubmit sizeM" onclick="findId.action('ecudemo200642' , 'kcp'); return false;">확인</a>
            </div>
        </fieldset>
</div>
</div>
