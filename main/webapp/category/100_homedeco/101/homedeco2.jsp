...
<ol>
<li><a href="<%=request.getContextPath()%>/index.html">홈</a></li>
...
<ul class="menuCategory">
						<li style="display:run-in;"
							...
							href="<%=request.getContextPath()%>/basketbox/52/index.html">수납함&바구니<span
								class="count displaynone">()</span></a></li>

						<li style="display:run-in;"
							 class="xans-element- xans-product xans-product-displaycategory  xans-record-"><a
							href="<%=request.getContextPath()%>/decoration/53/index.html">장식용품<span
								class="count displaynone">()</span></a></li>

						<li style="display:run-in;"
							 class="xans-element- xans-product xans-product-displaycategory  xans-record-"><a
							href="<%=request.getContextPath()%>/photoframe/54/index.html">액자그림&포스터<span
								class="count displaynone">()</span></a></li>
					</ul>
</div>
...
<span>BEST</span><span class="num">01</span>
                ...
                <div class="prdImg">
                    <a href=".<%=request.getContextPath()%>/product/샘플상품-07/42/category/45/display/2/index.html" name="anchorBoxName_42"><img src="//ecudemo200642.cafe24.com/web/product/medium/202110/8614d86c9cf54d8bf9d17497dc1b740d.jpg" id="eListPrdImage42_2" alt="샘플상품 07"/></a>
            ...
            <div class="description">
                ...
                <strong class="name"><a href="<%=request.getContextPath()%>/product/샘플상품-07/42/category/45/display/2/index.html" class=""><span class="title displaynone"><span style="font-size:11px;color:#555555;" data-i18n=PRODUCT.PRD_INFO_PRODUCT_NAME>상품명</span> :</span> <span style="font-size:11px;color:#555555;">샘플상품 07</span></a></strong>
...
<span>BEST</span><span class="num">02</span>
                ...
                <div class="prdImg">
                    <a href="<%=request.getContextPath()%>/product/sample-product-06/41/category/45/display/2/index.html" name="anchorBoxName_41"><img src="//ecudemo200642.cafe24.com/web/product/medium/202110/3e2961b47f9f78ef9a67e1bb290aad5e.jpg" id="eListPrdImage41_2" alt="sample product 06"/></a>
                    <span class="wish"> </span>
                </div>
            </div>
            <div class="description">
...
<span>BEST</span><span class="num">03</span>
                ...
                <div class="prdImg">
                    <a href="<%=request.getContextPath()%>/product/sample-product-05/40/category/45/display/2/index.html" name="anchorBoxName_40"><img src="//ecudemo200642.cafe24.com/web/product/medium/202110/30a3728facb2164bb332c92f3c106846.jpg" id="eListPrdImage40_2" alt="sample product 05"/></a>
                    <span class="wish"> </span>
                </div>
            </div>
            <div class="description">
...
<span>BEST</span><span class="num">04</span>
                ...
                <div class="prdImg">
                    <a href="<%=request.getContextPath()%>/product/sample-product-04/39/category/45/display/2/index.html" name="anchorBoxName_39"><img src="//ecudemo200642.cafe24.com/web/product/medium/202110/3fa9de22432e687438c27d6618885ea6.jpg" id="eListPrdImage39_2" alt="sample product 04"/></a>
                    <span class="wish"> </span>
                </div>
            </div>
            <div class="description">
...
<div class="function" id="Product_ListMenu">
            ...
            <ul id="type" class="xans-element- xans-product xans-product-orderby"><li class="xans-record-"><a href="<%=request.getContextPath()%>/category/outer/45/?cate_no=45&sort_method=5#Product_ListMenu" >신상품</a></li>
...
<li class="xans-record-"><a href="<%=request.getContextPath()%>/category/outer/45/?cate_no=45&sort_method=2#Product_ListMenu" >제조사</a></li>
<li class="xans-record-"><a href="<%=request.getContextPath()%>/category/outer/45/?cate_no=45&sort_method=7#Product_ListMenu" >사용후기</a></li>
</ul>
...
<span>BEST</span><span class="num">01</span>
                ...
                <div class="prdImg" id="prdImg">
                    <a href="<%=request.getContextPath()%>/product_detail/100_homedeco/110_basketbox/basket_product01/product01.jsp" name="anchorBoxName_42"><img src="<%=request.getContextPath()%>/web/product/medium/202110/8614d86c9cf54d8bf9d17497dc1b740d.jpg" id="eListPrdImage42_2" alt="샘플상품 07"/></a>
                    <span class="wish"> </span>
                </div>
            </div>
            <div class="description">
...
//	$("#prdImg").append("<img src='web/product/medium/202110/"+i+".jpg'>");
//	$("#prdImg").eq(i).append("<img src='web/product/medium/202110/"+i+".jpg'>");


 for(i=0;i<10;i++) {
	//$("#prdImg").append("<img src='../../../web/product/medium/202110/"+i+".jpg' width='100' height='100'>");
	$("#eListPrdImage42_2").children().eq(i).append("<img src='../../../web/product/medium/202110/"+i+".jpg' width='100' height='100'>");
...
<ol>
<li class="xans-record-"><a href="<%=request.getContextPath()%>/category/outer/45/?page=1" class="this">1</a></li>
        <li class="xans-record-"><a href="<%=request.getContextPath()%>/category/outer/45/?page=2" class="other">2</a></li>
            </ol>
...
<a href="<%=request.getContextPath()%>/category/outer/45/?page=2" class="last"><img src="//img.echosting.cafe24.com/skin/base/common/btn_page_last.gif" alt="마지막 페이지"/></a>
        ...
        <div class="footer_ins">
            <div class="insta"><h2><img src="<%=request.getContextPath()%>/um/title_insta.png" alt=""/> INSTAGRAM <span>@your id</span></h2>
                <ul><li>
                    <li>
                    <li>
                    <li>
                    ...
                    <li>
                    <li>
                </ul><!-- <section id="instagramWidgetManual" style="margin-left: 1%;margin-right: 1%;width: 98%;height: 190px;">  --></div>
        </div>
        <div id="gotop" style="display:none">
            <a href="#header"><img src="<%=request.getContextPath()%>/um/go_top.png" alt="맨위로"/></a>
            <a href="#bottom"><img src="<%=request.getContextPath()%>/um/go_down.png" alt="맨아래로"/></a>
        </div>
